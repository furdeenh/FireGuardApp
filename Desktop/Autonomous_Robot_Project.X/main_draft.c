...
//            state = 1;
//        }
//        sprintf(buff," %d%d%d%d", sensor1,sensor2,sensor3,sensor4);
//        LCD_WriteStringAtPos(buff, 1, 6);
//        if (state == 1) {
//
//            LCD_WriteStringAtPos("    Mike Hawk    ", 0, 0);
//            //LED_SetGroupValue(LED);
...
////        v3 = d3 % 1000;
////        v4 = d4  % 10000;
//        //SSD_WriteDigits(v1 %10, v2 % 100, v3 % 1000, v4 % 10000, 0, 0, 0, 0);
//        SSD_WriteDigits(v1, v2, v3, v4, 0, 0, 0, 0);
//
//        //IFS0bits.T2IF = 0; // clear interrupt flag
//        IEC0bits.T2IE = 1; // enable interrupt
...
//
//    if(sensor4 == 1 && sensor3 ==1 && sensor2 ==1 && sensor1 ==1){
//        Reverse_right();
//        Reverse_left();
//    }
...
////        OC4RS = PR3 * 3 / 40;
////
////        // x =2; PWM waveform 0.5 high and 0.5 low
////    }
////    if (Sw0 == 1 && Sw1 == 0) {
////
////        OC4RS = PR3 / 20;
